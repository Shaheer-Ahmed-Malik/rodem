...
//         backgroundColor:
//           cursorColor === "#000000" ? "rgba(255, 255, 255, 0.2)" : "rgba(0, 0, 0, 0.2)",
//         boxShadow: `0 0 15px 5px ${cursorColor}`, // Glow effect
//       }}
//     />
//   );
// };
  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundColor:
          cursorColor === "#000000" ? "rgba(255, 255, 255, 0.2)" : "rgba(0, 0, 0, 0.2)",
        boxShadow: `0 0 8px 2px ${cursorColor}`, // Subtle glow effect
      }}
    />
  );
};
